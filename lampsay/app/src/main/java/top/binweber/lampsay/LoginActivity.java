...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        username_in = (EditText) findViewById(R.id.email);
        password_in = (EditText) findViewById(R.id.password);
        final TextView mLoginButton = (TextView) findViewById(R.id.login_tv);
        mLoginButton.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view){
                mLoginButton.setTextColor(getResources().getColor(R.color.colorPrimary));
                attemptLogin();
            }
        });

        username_up = (EditText) findViewById(R.id.email_singup);
        password_up = (EditText) findViewById(R.id.password_singup);
        password_again = (EditText) findViewById(R.id.password_confirm);
        final TextView mRegisterButton = (TextView) findViewById(R.id.singup_big_tv);
        mRegisterButton.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view){
                mRegisterButton.setTextColor(getResources().getColor(R.color.colorAccent));
                attemptRegister();
            }
        });
        ...
        username_in.setOnFocusChangeListener(focuslistene);
        password_in.setOnFocusChangeListener(focuslistene);
        username_up.setOnFocusChangeListener(focuslistene);
        password_up.setOnFocusChangeListener(focuslistene);
        password_again.setOnFocusChangeListener(focuslistene);
    }

    private void attemptLogin() {
        username_in.setError(null);
        password_in.setError(null);

        final String username = username_in.getText().toString();
        ...
        if(TextUtils.isEmpty(username)) {
            username_in.setError(getString(R.string.error_field_required));
            focusView = username_in;
            cancel = true;
        }

        if(TextUtils.isEmpty(password)) {
            password_in.setError(getString(R.string.error_invalid_password));
            focusView = password_in;
            cancel = true;
        }
    ...
    private void attemptRegister() {
        username_up.setError(null);
        password_up.setError(null);
        password_up.setError(null);

        String username = username_up.getText().toString();
        String password = password_up.getText().toString();
        String passwordAgain = password_again.getText().toString();

        boolean cancel = false;
        View focusView = null;

        if(TextUtils.isEmpty(username)){
            username_up.setError(getString(R.string.error_field_required));
            focusView = username_up;
            cancel = true;
        }

        if(TextUtils.isEmpty(password)){
            password_up.setError(getString(R.string.error_field_required));
            focusView = password_up;
            cancel = true;
        }
        ...
        if(!TextUtils.isEmpty(passwordAgain) && !password.equals(passwordAgain)){
            password_again.setError(getString(R.string.error_incorrect_password));
            focusView = password_again;
            cancel = true;
        }
    ...
    public void showSingUp(View view) {
        ...
        final float tv_target_x = singupTV.getX();
        final float tv_target_y = singupTV.getY();
        ...
        Animation a = new Animation() {
            ...
            protected void applyTransformation(float interpolatedTime, Transformation t) {
                ...
                if (interpolatedTime >= 0.2f && interpolatedTime < 0.3f) {
                    twitterImageView.setImageResource(R.drawable.ic_weibo);
                } else if (interpolatedTime >= 0.45f && interpolatedTime < 0.55f) {
                    instagramImageView.setImageResource(R.drawable.ic_qq);
                } else if (interpolatedTime >= 0.65f && interpolatedTime < 0.75f) {
                    facebokImageView.setImageResource(R.drawable.ic_wechat);
                }
    ...
    public void showLogIn(View view) {
        ...
        final float tv_target_x = loginTV.getX();
        final float tv_target_y = loginTV.getY();
        ...
        Animation a = new Animation() {
            ...
            protected void applyTransformation(float interpolatedTime, Transformation t) {
                ...
                if (interpolatedTime >= 0.2f && interpolatedTime < 0.3f) {
                    facebokImageView.setImageResource(R.drawable.ic_weibo);
                } else if (interpolatedTime >= 0.45f && interpolatedTime < 0.55f) {
                    instagramImageView.setImageResource(R.drawable.ic_qq);
                } else if (interpolatedTime >= 0.65f && interpolatedTime < 0.75f) {
                    twitterImageView.setImageResource(R.drawable.ic_wechat);
                }
